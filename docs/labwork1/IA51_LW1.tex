...
\documentclass[article,english,nodocumentinfo]{utbmciadreport}

\input{../common/preamble.tex}

\declaredocument{Introduction to SARL and Creation of a PacMan Game}{Lab Works \#1}{UTBM-INFO-IA51-LW1}
