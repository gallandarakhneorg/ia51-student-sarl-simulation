...
\declaredocument{VI51 Lab Work \#3}{Coordinated Movement Algorithms}{UTBM-INFO-VI51-LW3}
...
\gdef\skeletonName{\texttt{\mbox{LW3\_VI51\_skeleton\string.jar}}}
...
Figure \figref{classdiagram} provides you the UML class diagram of the formation pattern API.

\mfigure[p]{width=\linewidth}{classdiagram}{Class diagram of the formation pattern API}{classdiagram}
...
\begin{upmcaution}
\Emph{Caution:} It is important to have a clear distinction between the concepts of ``formation slot'', ``agent'', and ``agent body''. \newline\newline
...
The function \code{allocate()} is invoked by the following agents for obtaining the index of the slot that should be used.
