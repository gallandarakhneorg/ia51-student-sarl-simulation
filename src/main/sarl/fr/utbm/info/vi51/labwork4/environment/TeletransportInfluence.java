...
/**
 * Influence for teletransporting an object.
 * 
 * @author St&eacute;phane GALLAND &lt;stephane.galland@utbm.fr&gt;
 * @version $Name$ $Revision$ $Date$
 */
public class TeletransportInfluence extends Influence {
	 ...
	 */
	public TeletransportInfluence(UUID influencedObject, Point2f position) {
	...
	public String toString() {
		return "MOVE TARGET @ " + getPosition();
	}
