 ...
 */
package fr.utbm.info.vi51.labwork5.gui;
...
import fr.utbm.info.vi51.labwork5.MainProgram;
import fr.utbm.info.vi51.labwork5.environment.ExtendedWorldModelState;
...
public class GUI extends AbstractFrameworkGUI {
	...
	protected void paintAgentBody(Graphics2D g2d,
		...
		if (this.showIcons.isSelected()) {
			paintIcon(g2d, STANDARD_RABBIT_ICON, positionOnScreen, orientationOnScreen);
		}
		else {
